                    ...
                    <div class="table-responsive" >
                        <table id="example2" class="table table-striped table-bordered" style="white-space: pre-wrap">
                            ...
                            <tr style="text-align: center; vertical-align: middle;">
                                ...
                                <td>{{$rs->subject}}</td>
                                <td>{{$rs->status}}</td>
                                <td><a style="color: black" onclick="return !window.open(this.href,'','top=50 left=100 width=1100,height=700')" href="{{route('admin.message.show',['id'=>$rs->id])}} "><button type="button" class="btn btn-outline-info active">Show</button></a></td>
                                ...
                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                    <div class="modal-content bg-danger">
                                        ...
                                        <div class="modal-body text-white mx-auto">
                                            ...
                                            <p>Message will be deleted.</p>
                                            <p>Are you sure?</p>

                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-light" data-bs-dismiss="modal">Discard</button>
                                            <a href="{{route('admin.message.destroy',['id'=>$rs->id])}}"><button type="button" class="btn btn-dark">Delete</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
