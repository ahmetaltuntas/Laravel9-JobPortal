                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-primary">Edit Job</h5>
                            </div>
                            <hr>
                            <form class="row g-3" action="{{route('admin.job.update',['id'=>$data->id])}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row-md-6">
                                ...
                                <div class="row-md-6">
                                    ...
                                    <select class="form-select mb-3" aria-label="Default select example" name="typeof">
                                        <option selected="">{{$data->typeof}}</option>
